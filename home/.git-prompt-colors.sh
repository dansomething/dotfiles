...
function get_username() {
  ...
  echo "${Magenta}$USER${White}${ResetColor} "
}
function get_hostname() {
  ...
  echo "${BoldRed}$HOSTNAME${ResetColor} "
}
...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_START_USER="$(get_username)$(get_hostname)${Yellow}${PathShort}${ResetColor}"
  # GIT_PROMPT_START_ROOT="_LAST_COMMAND_INDICATOR_ ${GIT_PROMPT_START_USER}"
  GIT_PROMPT_START_ROOT="$(get_username)$(get_hostname)${GIT_PROMPT_START_USER}"
